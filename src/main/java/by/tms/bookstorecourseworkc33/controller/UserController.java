...
public class UserController {
    ...
    @GetMapping
    public ModelAndView userList(@AuthenticationPrincipal User user, ModelAndView modelAndView) {
    ...
    @PreAuthorize("hasAuthority('ADMIN')")
    @GetMapping("{id}")
    public ModelAndView getUserEditForm(@PathVariable("id") long id, ModelAndView modelAndView) {
    ...
    @PreAuthorize("hasAuthority('ADMIN')")
    @PostMapping("{id}")
    public ModelAndView postUserEditForm(@ModelAttribute("userUpdate") UserDto userDto, @PathVariable("id") long id, ModelAndView modelAndView) {
